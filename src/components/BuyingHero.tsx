        ...
        >
            ...
            <div className="absolute inset-0">
                <Image
                    ...
                    style={{ filter: "brightness(0.8) saturate(1)" }}
                    priority
                />
            </div>
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(to bottom, rgba(13,13,13,0.05) 0%, rgba(13,13,13,0.85) 100%)",
                }}
            />
            <div
                className="absolute inset-0 pointer-events-none"
                style={{
                    background: "radial-gradient(circle at center, transparent 0%, rgba(13,13,13,0.2) 100%)",
                }}
            />
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-4 mt-16 max-w-4xl">
                ...
                >
                    Find Your <span style={{ color: "var(--color-gold-muted)" }}>Perfect Home</span>
                </h1>
                ...
                >
                    Navigate the real estate market with confidence. From browsing curated listings to handing you the keys, we provide expert guidance every step of the way.
                </p>
